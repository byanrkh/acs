  ...
  <table role="presentation" width="100%" style="max-width:560px;margin:0 auto;border-collapse:collapse;">
    <tr>
      <td style="padding:0 0 16px;text-align:center;">
        <span
          style="display:inline-block;background:#FFD400;border:3px solid #000;padding:6px 16px;font-size:11px;font-weight:900;letter-spacing:1.5px;text-transform:uppercase;color:#000;"
        >
          E-Ticket ACS
        </span>
      </td>
  ...
  >
    <tr>
      ...
      >
        <table role="presentation" width="100%">
          <tr>
            <td style="font-size:19px;font-weight:900;letter-spacing:0.5px;color:#fff;">ACS 2026 · ARCHIPELA<span style="color:#FFD400">PACE</span></td>
            <td style="text-align:right;">
              <span
                style="display:inline-block;background:#7ED957;border:2px solid #000;padding:4px 10px;font-size:10px;font-weight:900;letter-spacing:1px;text-transform:uppercase;color:#000;white-space:nowrap;"
              >
                Confirmed
              </span>
            </td>
    ...
    <tr>
      <td style="padding:26px 26px 8px;">
        ...
        <p style="margin: 0; font-size: 14px; inline-height: 1.6; color: #444">Anda telah terdaftar sebagai peserta Al Azhar Creative Steps 2026, Tunjukkan email ini & KTP/ID anda saat pengambilan Race Pack Collection.</p>
      </td>
    </tr>
        ...
        <table role="presentation" width="100%" style="border-collapse:collapse;border:3px solid #000;">
          <tr>
            <td class="acs-ticket-main" width="60%" style="padding:20px;vertical-align:top;">
              <p style="margin:0 0 3px;font-size:10px;text-transform:uppercase;letter-spacing:1px;color:#999;">
                Nama di BIB
              </p>
              ...
              <table role="presentation" width="100%" style="border-collapse:collapse;">
                <tr>
                  <td style="padding:0 0 10px;width:50%;">
                    <p style="margin:0 0 2px;font-size:10px;text-transform:uppercase;letter-spacing:1px;color:#999;">
                      Kategori
                    </p>
                ...
                <tr>
                  <td colspan="2" style="padding:6px 0 0;border-top:2px dashed #ccc;">
                    <p style="margin:8px 0 2px;font-size:10px;text-transform:uppercase;letter-spacing:1px;color:#999;">
                      Informasi Pengambilan Race Pack
                    </p>
                    <p style="margin:0;font-size:12.5px;line-height:1.5;color:#333;">
                      Sabtu, 22 Agustus 2026 · 06.00 WIB<br />SMAI Al Azhar 4 Kemang Pratama
                    </p>
                  </td>
                </tr>
              </table>
            ...
            <td
              class="acs-ticket-stub"
              width="40%"
              style="padding:20px;text-align:center;vertical-align:top;border-left:4px dashed #000;background:#FDF6E9;"
            >
              <p style="margin:0 0 2px;font-size:10px;text-transform:uppercase;letter-spacing:1px;color:#666;">
                Nomor BIB
              </p>
              ...
              />
              <p style="margin:8px 0 0;font-size:10px;color:#e0155f;line-height:1.4;">
    ...
    <tr>
      <td style="padding:0 26px 26px;">
        <p style="margin:0;font-size:11.5px;color:#999;line-height:1.6;">Simpan email ini baik-baik sebagai bukti pendaftaran, Sampai bertemu di garis start!</p>
      </td>
    </tr>
  </table>
