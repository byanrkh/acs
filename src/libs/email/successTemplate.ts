  ...
  >
    <tr>
      ...
      >
        <table role="presentation" width="100%">
          <tr>
            <td style="font-size:19px;font-weight:900;letter-spacing:0.5px;color:#fff;">ACS 2026 · ARCHIPELAPACE</td>
    ...
    <tr>
      <td style="padding:26px 26px 8px;">
        ...
        <p style="margin:0;font-size:14px;line-height:1.6;color:#444;">
          Pembayaran kamu sudah kami terima dan pendaftaran resmi terkonfirmasi. Simpan e-tiket ini baik-baik, ya —
    ...
    <tr>
      <td style="padding:0 26px 26px;">
        <p style="margin:0;font-size:11.5px;color:#999;line-height:1.6;">Simpan email ini sebagai bukti pendaftaran.</p>
      </td>
    </tr>
  </table>
